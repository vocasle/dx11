...
{
public:
	void Initialize(ID3D11Device* device, const std::string& shaderBlobRootDir, const std::string& shaderSrcRootDir);
	...
	void UpdateVertexShader(const std::string& name, ID3D11VertexShader* shader);
