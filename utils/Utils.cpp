...
void
UtilsCreateVertexBuffer (ID3D11Device *device, const void *data, size_t num,
...
void
UtilsCreateIndexBuffer (ID3D11Device *device, const void *data, size_t num,
...
void
UtilsWriteData (const char *filepath, const char *bytes, const size_t sz,
                const bool isBinary)
{
  FILE *out = nullptr;
...
void
UtilsUpdateConstantBuffer (ID3D11DeviceContext *context, size_t bufferSize,
...
void
UtilsCreateConstantBuffer (ID3D11Device *device, size_t byteWidth,
                           ID3D11Buffer **pDest)
{
  D3D11_BUFFER_DESC bufferDesc = {};
