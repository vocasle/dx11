...
Vec4D MathVec4DVectorPermute(Vec4D V1, Vec4D V2, uint32_t PermuteX,
			     ...
			     uint32_t PermuteW)
{
	assert(PermuteX <= 7 && PermuteY <= 7 && PermuteZ <= 7 &&
	       PermuteW <= 7);
...
void TestVec2D(void)
{
	...
	assert(MathNearlyEqual(vec1.X, -0.5f) &&
	       MathNearlyEqual(vec1.Y, -2.0f));
	...
	assert(MathNearlyEqual(vec3.X, -1.2f) &&
	       MathNearlyEqual(vec3.Y, -0.6f));
...
void TestVec3D(void)
{
	...
	assert(MathNearlyEqual(vec3.X, -12.0f) &&
	       MathNearlyEqual(vec3.Y, -6.0f));
