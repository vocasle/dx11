...
struct Material
{
	Material() : Ambient{}, Diffuse{}, Specular{}, Reflection{} {}
	Material(Color ambient, Color diffuse, Color specular, Color reflection): Ambient(ambient), Diffuse(diffuse), Specular(specular), Reflection(reflection) {}
	Color Ambient;
	Color Diffuse;
	Color Specular;
	Color Reflection;
