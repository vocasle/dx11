...
void
InputLayout::CreateDefaultLayout (ID3D11Device *device, unsigned char *bytes,
                                  size_t bufferSize)
{
...
void
InputLayout::CreateSkyLayout (ID3D11Device *device, unsigned char *bytes,
                              size_t bufferSize)
{
...
void
InputLayout::CreateParticleLayout (ID3D11Device *device, unsigned char *bytes,
                                   size_t bufferSize)
{
...
size_t
InputLayout::GetVertexSize (VertexType vertexType)
{
