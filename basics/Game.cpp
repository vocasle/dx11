...
Game::UpdateImgui ()
{
  ...
  if (ImGui::CollapsingHeader ("Cube 0"))
    {
      ...
      ImGui::SliderFloat ("Cube 0 Pos.X", &cubePositions[0].X, -10.0f, 10.0f,
                          "%f", 1.0f);
      ImGui::SliderFloat ("Cube 0 Pos.Y", &cubePositions[0].Y, -10.0f, 10.0f,
                          "%f", 1.0f);
      ImGui::SliderFloat ("Cube 0 Pos.Z", &cubePositions[0].Z, -10.0f, 10.0f,
                          "%f", 1.0f);
  ...
  if (ImGui::CollapsingHeader ("Cube 1"))
    {
      ImGui::SliderFloat ("Cube 1 scale", &cubeScales[1], 0.1f, 2.0f, "%f",
                          1.0f);

      ImGui::SliderFloat ("Cube 1 Pos.X", &cubePositions[1].X, -10.0f, 10.0f,
                          "%f", 1.0f);
      ImGui::SliderFloat ("Cube 1 Pos.Y", &cubePositions[1].Y, -10.0f, 10.0f,
                          "%f", 1.0f);
      ImGui::SliderFloat ("Cube 1 Pos.Z", &cubePositions[1].Z, -10.0f, 10.0f,
                          "%f", 1.0f);
  ...
  if (ImGui::CollapsingHeader ("Cube 2"))
    {
      ImGui::SliderFloat ("Cube 2 scale", &cubeScales[2], 0.1f, 2.0f, "%f",
                          1.0f);
      ImGui::SliderFloat ("Cube 2 Pos.X", &cubePositions[2].X, -10.0f, 10.0f,
                          "%f", 1.0f);
      ImGui::SliderFloat ("Cube 2 Pos.Y", &cubePositions[2].Y, -10.0f, 10.0f,
                          "%f", 1.0f);
      ImGui::SliderFloat ("Cube 2 Pos.Z", &cubePositions[2].Z, -10.0f, 10.0f,
                          "%f", 1.0f);
...
Game::Game () { m_DR = std::make_unique<DeviceResources> (); }
...
Game::Initialize (HWND hWnd, uint32_t width, uint32_t height)
{
  ...
  g_Cube
      = OLLoad (UtilsFormatStr ("%s/meshes/cube.obj", ASSETS_ROOT).c_str ());
...

  {
    D3D11_INPUT_ELEMENT_DESC desc[] = {
      ...
      { "TEXCOORD", 0, DXGI_FORMAT_R32G32_FLOAT, 0,
        offsetof (Vertex, TexCoord), D3D11_INPUT_PER_VERTEX_DATA, 0 },
    };

    HR (device->CreateInputLayout (desc, sizeof (desc) / sizeof (desc[0]),
                                   &bytes[0], bytes.size (),
